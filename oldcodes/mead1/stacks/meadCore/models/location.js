...
class Location extends HotspringModel {
  ...
  static sequelizeConnections = [
    { connectionType: "1M", parentmodel: "location", childParentKey: 'locationID', childmodel: "device", required: true },
    { connectionType: "1M", parentmodel: "location", childParentKey: 'locationID', childmodel: "network", required: true }
  ];
