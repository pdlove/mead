...
var ipNetToMediaTable = {
    BaseOID: '1.3.6.1.2.1.4.22',
    Columns: {
        1: { name: "ipNetToMediaIfIndex" },
        2: { name: "ipNetToMediaPhysAddress", type: "hex" },
        3: { name: "ipNetToMediaNetAddress" },
        4: { name: "ipNetToMediaType", type: "enum", enum: { 1: "other", 2: "invalid", 3: "dynamic", 4: "static", 5: "local" } }
    }
};
