/*
  ...
  - You are about to drop the column `parentDeviceID` on the `devices` table. All the data in the column will be lost.
...
INSERT INTO "new_devices" ("DeviceID", "connectionNotes", "deviceCategoryId", "downNotificationSent", "ip", "isDHCP", "lastPoll", "lastResponse", "mac", "model", "name", "type") SELECT "DeviceID", "connectionNotes", "deviceCategoryId", "downNotificationSent", "ip", "isDHCP", "lastPoll", "lastResponse", "mac", "model", "name", "type" FROM "devices";
DROP TABLE "devices";
