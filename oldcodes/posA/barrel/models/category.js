...
export default class Category extends CarpenterModel {
    ...
    static sequelizeConnections = [
        new CarpenterModelRelationship({ connectionType: "1M", 
            relationshipNameFromParent: "categories", parentModelName: "Organization", //parentKey defaults to the primary key. requiredForParent is only valid if anything but the primary key is used.
            relationshipNameFromChild:"organization", requiredForChild: true, childParentKey: 'organizationID', childModelName: "Category" }),
        new CarpenterModelRelationship({ connectionType: "1M", 
            relationshipNameFromParent: "parent", parentModelName: "Category", //parentKey defaults to the primary key. requiredForParent is only valid if anything but the primary key is used.
            relationshipNameFromChild:"children", requiredForChild: true, childParentKey: 'parentCategoryID', childModelName: "Category" }),
    ];
    //TODO: Seed Data for a Category
    static seedDataCore = [
        {
