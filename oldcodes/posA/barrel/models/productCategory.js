...
export default class ProductCategory extends CarpenterModel {
    ...
    static sequelizeConnections = [
        new CarpenterModelRelationship({ connectionType: "1M", 
            relationshipNameFromParent: "productCategories", parentModelName: "Organization", //parentKey defaults to the primary key. requiredForParent is only valid if anything but the primary key is used.
            relationshipNameFromChild:"organization", requiredForChild: true, childParentKey: 'organizationID', childModelName: "ProductCategory" }),
        new CarpenterModelRelationship({ connectionType: "1M", 
